...
{% include image.html file="{{ site.baseurl }}/assets/images/san-juan-mountains.jpg" alt="Dãy núi San Juan thật đẹp" title="Dãy núi San Juan" lazy="yes" %}
...
<div>
  ...
  {% include image.html file="{{ site.baseurl }}/assets/images/shiprock.jpg" alt="Một tảng đá cũ trên sa mạc" title="Shiprock, New Mexico bởi Beau Rogers" lazy="yes" %}
  </a>
</div>
